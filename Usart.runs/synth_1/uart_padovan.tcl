...
synth_design -top uart_padovan -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef uart_padovan.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file uart_padovan_utilization_synth.rpt -pb uart_padovan_utilization_synth.pb"  } 
